...
function Tooltip(props: React.HTMLProps<HTMLDivElement> & { textColor?: string; textSize?: string; shadowColor?: "Crimson" | "Verde" }) {
    const style: React.CSSProperties = {};
    props.textColor && (style.color = props.textColor);
    props.textSize && (style.fontSize = props.textSize);
    return (
        <div {...props} className="absolute top-0 left-1/2 z-10 flex -translate-y-full -translate-x-1/2 flex-col items-center justify-center ">
            <div
                style={style}
